                ...
                <v-form ref="form" validate-on="input">
                    ...
                    <v-col>
                        <v-row class="d flex justify-space-between">
                            <v-text-field v-model="cliente.nome" class="mr-10" label="Nome Completo" outlined counter
                                maxlength="150" :rule="rules" hint="Limite de 150 caracteres"></v-text-field>
                        ...
                        <v-row class="d-flex justify-space-between align-center">
                            <v-text-field v-model="cliente.email" aria-required="true" class="mr-6" label="email" outlined
                                counter maxlength="150" :rules="rules" hint="Limite de 150 caracteres"></v-text-field>
                        </v-row>
                        ...
                        <v-row class="d-flex justify-space-between align-center mt-10 mr-3">
                            ...
                            <v-text-field v-model="cliente.bairro" class="mr-10" label="Bairro" outlined hide-details
                                counter maxlength="150" hint="Limite de 150 caracteres"></v-text-field>
                            <v-text-field v-model="cliente.numResidencia" ref="form" style="max-width: 350px" label="Número"
                                outlined hide-details counter maxlength="4" hint="Limite de 4 caracteres"></v-text-field>
                        </v-row>
